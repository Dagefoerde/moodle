...
class repository_nextcloud_access_controlled_link_manager_testcase extends advanced_testcase {
    ...
    /** @var null|\repository_nextcloud\test\testable_access_controlled_link_manager the access_controlled_link_manager. */
    ...
    protected function setUp() {
        ...
        $this->linkmanager = new \repository_nextcloud\test\testable_access_controlled_link_manager($this->ocsmockclient,
    ...
    public function test_construction() {
        $mockclient = $this->getMockBuilder(\repository_nextcloud\ocs_client::class
        )->disableOriginalConstructor()->disableOriginalClone()->getMock();
        ...
        $this->expectException('repository_nextcloud\request_exception');
        $this->linkmanager = new \repository_nextcloud\access_controlled_link_manager($mockclient, $this->issuer, 'nextcloud');
